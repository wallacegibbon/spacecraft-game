...
public:
	Bullet(
		QString image, QString sound, int damage = 1,
		int max_shoot_interval = 200, Spacecraft *player = nullptr
	);
...
public:
	Bullet_0(Spacecraft *player = nullptr) :
		Bullet(
			":/image/bullet_0.png", "qrc:/sound/weapon_0.wav",
			2, 100, player
		) {}
};
...
public:
	Bullet_1(Spacecraft *player = nullptr) :
		Bullet(
			":/image/bullet_1.png", "qrc:/sound/weapon_1.wav",
			5, 300, player
		) {}
};
