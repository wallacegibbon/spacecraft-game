...
KeyboardController::KeyboardController(int _repeat_interval,
	QGraphicsItem *parent)
	: repeat_interval(_repeat_interval), QGraphicsRectItem(parent)
{
	setFlag(QGraphicsItem::ItemIsFocusable);
	repeat_timer = new QTimer(this);
	connect(repeat_timer, &QTimer::timeout,
		this, &KeyboardController::repeat_handler);
...
void KeyboardController::repeat_handler() {
	/*
	qDebug() << "repeat handler is triggered, press_stack: "
		<< press_stack;
	*/
